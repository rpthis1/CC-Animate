...
{
    public class ContentTreeFetchAllVertexEnabledParametersListController : ApiController
    {
        // GET api/ipmvpd

        private readonly IContentTreeFetchEnabledParameterListProcessor _processor;
        private readonly IDataMapper _mapper;
        public ContentTreeFetchAllVertexEnabledParametersListController(IContentTreeFetchEnabledParameterListProcessor processor, IDataMapper mapper)
        {
