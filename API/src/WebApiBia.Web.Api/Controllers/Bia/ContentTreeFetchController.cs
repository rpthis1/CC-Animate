...
{
    public class ContentTreeFetchController : ApiController
    {
        // GET api/ipmvpd

        private readonly IContentTreeFetchProcessor _processor;
        private readonly IDataMapper _mapper;
        public ContentTreeFetchController(IContentTreeFetchProcessor processor, IDataMapper mapper)
        {
