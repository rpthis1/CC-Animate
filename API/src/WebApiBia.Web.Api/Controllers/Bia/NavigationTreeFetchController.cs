...
{
    public class NavigationTreeFetchController : ApiController
    {
        // GET api/ipmvpd

        private readonly INavigationTreeFetchProcessor _processor;
        private readonly IDataMapper _mapper;
        public NavigationTreeFetchController(INavigationTreeFetchProcessor processor, IDataMapper mapper)
        {
