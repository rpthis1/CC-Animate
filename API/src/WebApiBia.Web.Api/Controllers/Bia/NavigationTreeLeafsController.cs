...
{
    public class NavigationTreeLeafsController : ApiController
    {
        // GET api/ipmvpd

        private readonly INavigaionTreeProcessor _processor;
        public NavigationTreeLeafsController(INavigaionTreeProcessor processor)
        {
        ...
        {
            string result = _processor.Get(cluster, record, true);
