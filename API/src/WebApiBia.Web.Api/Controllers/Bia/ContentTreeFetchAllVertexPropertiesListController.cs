...
{
    public class ContentTreeFetchAllVertexPropertiesListController : ApiController
    {
        // GET api/ipmvpd

        private readonly IContentTreeFetchAllPropertiesListProcessor _processor;
        private readonly IDataMapper _mapper;
        public ContentTreeFetchAllVertexPropertiesListController(IContentTreeFetchAllPropertiesListProcessor processor, IDataMapper mapper)
        {
