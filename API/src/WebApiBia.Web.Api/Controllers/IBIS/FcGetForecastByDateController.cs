...
{
    public class FcGetForecastByDateController : ApiController
    {
        // GET api/ipmvpd

        private readonly IFcGetForecastByDateProcessor _processor;
        public FcGetForecastByDateController(IFcGetForecastByDateProcessor processor)
        {
        ...
        public HttpResponseMessage Get()
        {
            ...
            string result = _processor.Get(type, location,date);
