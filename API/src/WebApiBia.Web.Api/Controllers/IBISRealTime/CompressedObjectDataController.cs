...
{
    public class CompressedObjectDataController : ApiController
    {
        // GET api/ipmvpd

        private readonly ICompressedObjectDataProcessor _processor;
        public CompressedObjectDataController(ICompressedObjectDataProcessor processor)
        {
