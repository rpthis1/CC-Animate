...
{
    class CO2WidgetCreator : IWidgetCreator
    {
        ...
        public void CreateWidget(int clusterId, int recordId)
        {
            ...
            using (NpgsqlConnection con = new NpgsqlConnection(constr))
            {
                ...
                _genericWidgetCreators.CreateWidgetParent(con, clusterId, recordId, maxOrder, "CO2 REPORT", "resources/images/vertex/barchartBrown.png", "CO2 (lbs)", GetType().Name);

                var lastInsertedVertexContentNavigationId = _genericQueriesPg.LastInsertedVertexContentNavigationId(con);
                _genericWidgetCreators.CreateBiaVReportPropertyString(con, lastInsertedVertexContentNavigationId, ++maxOrder, clusterId, "reportProvider", "CO2 Report");
                ...
                _genericWidgetCreators.CreateWidgetValuesClass(con, lastInsertedVertexContentNavigationId, ++maxOrder, clusterId, "parameter decorators", _widgetConfigGenerator.GetCo2BiaVReportPropertyParameterDecorators());
