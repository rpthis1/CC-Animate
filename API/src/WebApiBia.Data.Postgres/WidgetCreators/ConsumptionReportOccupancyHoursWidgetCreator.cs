...
{
    class ConsumptionReportOccupancyHoursWidgetCreator : IWidgetCreator
    {
        ...
        public void CreateWidget(int clusterId, int recordId)
        {
            ...
            using (NpgsqlConnection con = new NpgsqlConnection(constr))
            {
                ...
                _genericWidgetCreators.CreateWidgetParent(con, clusterId, recordId, maxOrder, "CONSUMPTION REPORT - OCCUPANCY HOURS", "resources/images/vertex/occupancy24Hours.png", "Occupancy (Hours)", GetType().Name);
                ...
                _genericWidgetCreators.CreateWidgetValuesClass(con, lastInsertedVertexContentNavigationId, ++maxOrder, clusterId, "parameter decorators", _widgetConfigGenerator.GetConsumptionReportEntityValueTypeOccupancyBiaVReportPropertyParameterDecorators());
