...
{
    class PowerConsumptionKwhWidgetCreator : IWidgetCreator
    {
        ...
        public void CreateWidget(int clusterId, int recordId)
        {
            ...
            using (NpgsqlConnection con = new NpgsqlConnection(constr))
            {
                ...
                _genericWidgetCreators.CreateWidgetParent(con, clusterId, recordId, maxOrder, "CONSUMPTION REPORT", "resources/images/vertex/barchartYellow.png", "Power Consumption (kWh)", GetType().Name);
