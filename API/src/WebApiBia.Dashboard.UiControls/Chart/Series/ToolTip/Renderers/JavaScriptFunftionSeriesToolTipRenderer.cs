...
{
    public class JavaScriptFunftionSeriesToolTipRenderer : JavaScripFunctionAxisRenderer
    {
        public JavaScriptFunftionSeriesToolTipRenderer()
        {
        ...
        private void GenerateFunctionBoby()
        {
            ...
            sb.Append("{");
            sb.Append("   this.setHtml( item.field + ':  ' + value + ' ' + options.leftUnits + '  (' + storeItem.get('cat') +')' );");
            sb.Append("}");
