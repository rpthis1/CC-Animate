...
{
    public class ReportPropertiesMobileController : ApiController
    {
        // GET api/ipmvpd

        private readonly IReportPropertiesMobileProcessor _processor;
        private readonly IDataMapper _mapper;
        public ReportPropertiesMobileController(IReportPropertiesMobileProcessor processor, IDataMapper mapper)
        {
