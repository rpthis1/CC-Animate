...
{
    class ContentTreeFetchAllProcessor : IContentTreeFetchAllProcessor
    {
        ...
        public ContentTreeFetchAllProcessor(IContentTreeFetchQueryProcessor querProcessor, IContentTreeFetchExtractor contentTreeFetchExtractor)
        {
        ...
        public string Get(object p)
        {
            ...
            TreeParent parent = _contentTreeFetchExtractor.Extract(json,false);
