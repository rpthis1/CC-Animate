...
{
    public class NavigationTemplateController : ApiController
    {
        // GET api/ipmvpd

        private readonly INavigationTemplateProcessor _processor;
        public NavigationTemplateController(INavigationTemplateProcessor processor)
        {
