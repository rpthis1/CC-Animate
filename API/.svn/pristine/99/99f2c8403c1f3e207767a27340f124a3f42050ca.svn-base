...
{
    class OccupancyPercentByHourWidgetCreator : IWidgetCreator
    {
        ...
        public void CreateWidget(int clusterId, int recordId)
        {
            ...
            using (NpgsqlConnection con = new NpgsqlConnection(constr))
            {
                ...
                _genericWidgetCreators.CreateWidgetParent(con, clusterId, recordId, maxOrder, "OCCUPANCY PERCENTAGE BY HOUR REPORT", "resources/images/vertex/occupancyPercentageByHour.png", "Occupancy (%) by Hour", GetType().Name);

                var lastInsertedVertexContentNavigationId = _genericQueriesPg.LastInsertedVertexContentNavigationId(con);

                _genericWidgetCreators.CreateBiaVReportPropertyString(con, lastInsertedVertexContentNavigationId, ++maxOrder, clusterId, "reportProvider", "Occupancy Percentage By Hour Report");
                ...
                _genericWidgetCreators.CreateBiaVReportPropertyString(con, lastInsertedVertexContentNavigationId, ++maxOrder, clusterId, "reportFormatter", "OccupancyPercentageByHourFormatter");
                ...
                _genericWidgetCreators.CreateWidgetValuesClass(con, lastInsertedVertexContentNavigationId, ++maxOrder, clusterId, "parameter decorators", _widgetConfigGenerator.GetOccupancyPercentageByHourBiaVReportPropertyParameterDecorators());
