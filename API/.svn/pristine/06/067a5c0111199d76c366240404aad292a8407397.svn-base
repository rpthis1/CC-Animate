...
{
    public class ContentTreeController : ApiController
    {
        // GET api/ipmvpd
        ...
        public ContentTreeController(IContentTreeProcessor processor, IDataMapper mapper, IContentTreeTemplateOwnerProcessor templateOwnerProcessor)
        {
