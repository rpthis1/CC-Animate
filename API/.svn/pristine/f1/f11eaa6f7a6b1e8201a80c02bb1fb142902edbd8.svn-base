...
{
    class PowerConsumptionMonthOverYearKwhWidgetCreator : IWidgetCreator
    {
        ...
        public void CreateWidget(int clusterId, int recordId)
        {
            ...
            using (NpgsqlConnection con = new NpgsqlConnection(constr))
            {
                ...
                _genericWidgetCreators.CreateWidgetParent(con, clusterId, recordId, maxOrder, "CONSUMPTION REPORT - MONTH OVER YEAR", "resources/images/vertex/barchartMonthOverYear.png", "Power Consumption  (kWh)", GetType().Name);
                ...
                _genericWidgetCreators.CreateBiaVReportPropertyString(con, lastInsertedVertexContentNavigationId, ++maxOrder, clusterId, "reportFormatter", "ConsumptionOverYearFormatter");
                _genericWidgetCreators.CreateBiaVReportPropertyString(con, lastInsertedVertexContentNavigationId, ++maxOrder, clusterId, "reportDataDecorator", "BarChartDecoratorMonthOverYear");
                ...
                _genericWidgetCreators.CreateWidgetValuesClass(con, lastInsertedVertexContentNavigationId, ++maxOrder, clusterId, "parameter decorators", _widgetConfigGenerator.GetConsumptionReportMonthOverYearBiaVReportPropertyParameterDecorators());
