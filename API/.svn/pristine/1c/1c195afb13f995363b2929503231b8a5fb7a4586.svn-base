...
namespace WebApiBia.Web.Api.Controllers.BiaMobile
{
    public class NavigationTreeFetchMobileController : ApiController
    {
        // GET api/ipmvpd

        private readonly INavigationTreeFetchMobileProcessor _processor;
        private readonly IDataMapper _mapper;
        public NavigationTreeFetchMobileController(INavigationTreeFetchMobileProcessor processor, IDataMapper mapper)
        {
        ...
        public HttpResponseMessage Get(int cluster, int record)
        {
            ...
            string result = _processor.Get(vertexParent, true);
