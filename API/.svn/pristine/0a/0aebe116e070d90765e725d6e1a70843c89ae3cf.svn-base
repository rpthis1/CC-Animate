...
{
    public class TemplateTabController : ApiController
    {
        // GET api/ipmvpd

        private readonly ITemplateTabProcessor _processor;
        public TemplateTabController(ITemplateTabProcessor processor)
        {
