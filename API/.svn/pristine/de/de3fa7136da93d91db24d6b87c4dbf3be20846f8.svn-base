...
{
    public class TemplateNodeController : ApiController
    {
        // GET api/ipmvpd

        private readonly ITemplateNodeProcessor _processor;
        public TemplateNodeController(ITemplateNodeProcessor processor)
        {
