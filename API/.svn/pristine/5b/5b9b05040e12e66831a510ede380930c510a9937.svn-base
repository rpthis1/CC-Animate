...
namespace WebApiBia.Web.Api
{
    public class NinjectConfigurator
    {
        ...
        private void ConfigureIbisRealTime(IKernel container)
        {
            ...
            container.Bind<ICompressedObjectDataProcessor>().To<CompressedObjectDataProcessor>().InRequestScope();
            container.Bind<ICompressedObjectProcessor>().To<CompressedObjectProcessor>().InRequestScope();
        }
