...
{
    public class TemplateTabNavigatorController : ApiController
    {
        // GET api/ipmvpd

        private readonly ITemplateTabNavigatoreProcessor _processor;
        public TemplateTabNavigatorController(ITemplateTabNavigatoreProcessor processor)
        {
