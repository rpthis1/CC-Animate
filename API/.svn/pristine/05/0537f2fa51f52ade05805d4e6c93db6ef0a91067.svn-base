...
{
    public class TemplateTabClient : ITemplateTabClient
    {
        ...
        public TemplateTabClient(IOrientClient orient, IJsonHelper json,
        ...
        public string Post(int cluster, int record, object p)
        {
            ...
            string parameter = String.Format("/TmpTreeCreateTab/{0}/{1}/{2}:{3}", vertex.Label, json, cluster, record);
